  ...
  return (
    <div className="edu-group mb-4" ref={sectionRef}>
      <div className="overflow-hidden">
        <h3
          className={`edu-heading text-darkred dark:text-lightred text-lg font-medium`}
        >
          {edu.title}
        </h3>
      </div>
      ...
      <ul
        role="list"
        className=" marker:text-darkred dark:marker:text-lightred list-disc pl-6 space-y-1 mt-1"
      >
        {edu.list.map((li) => (

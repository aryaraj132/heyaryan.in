...
const AppHead: React.FC<Props> = ({
  ...
  let author = "Aryan Raj";
  let description =
    "A Full Stack developer exploring the tech world. I like experimenting with new technologies, building small projects, and drinking lots of coffee.";
  let siteName = "Aryan Raj's Portfolio";
  let type = "website";
  ...
  let appOgImage = `${process.env.NEXT_PUBLIC_URL}/og.png`;
  let appOgImageAlt = "Aryan Raj's Portfolio";

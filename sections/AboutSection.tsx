...
const AboutSection: React.FC<Props> = ({ homePage = true }) => {
  ...
  return (
    ...
    >
      <section id="whoami" className={homePage ? "section" : "section mt-16"}>
        <RoughNotationGroup>
          <div className="text-center">
            <RoughNotation
              type="underline"
              color={`${
                theme === "light" ? "rgb(140, 0, 0)" : "rgb(220, 0, 0)"
              }`}
              strokeWidth={2}
              order={1}
              show={isSecOnScreen}
          ...
          <div className="md:grid grid-rows-5 lg:grid-rows-6 grid-cols-5">
            <div className="col-start-1 col-end-3 row-start-1 row-end-4 lg:row-end-7 lg:col-start-1 lg:col-end-3 flex justify-center items-center py-4 lg:mb-[20%]">
              <div className="relative w-72">
                <svg
                  ...
                  viewBox="0 0 96 21"
                  aria-hidden="true"
                  className="img-svg hidden lg:block fill-darkred dark:fill-lightred absolute -top-14 -left-14"
                ...
                <svg
                  ...
                  viewBox="0 0 15 14"
                  aria-hidden="true"
                  className="img-svg hidden lg:block fill-darkred dark:fill-lightred absolute bottom-8 -right-12"
                  xmlns="http://www.w3.org/2000/svg"
                >
            ...
            <p className="col-start-1 col-end-3 row-start-4 row-end-6 lg:row-start-1 lg:row-end-2 lg:col-start-3 lg:col-end-6 lg:ml-8 lg:mt-auto about-intro">
              ...
              <a title="Mailmodo" href="https://mailmodo.com" target="_blank" rel="noreferrer">
                Mailmodo.com
              </a>
              , I am skilled in Developement in various areas, and constently
              learning new things.
            </p>

            <div
              className="col-start-3 col-end-6 row-start-1 row-end-6 lg:row-start-2 lg:row-end-7 md:ml-8 place-content-end position-relative"
              ref={eduRef}
            >
            ...
            {!!homePage && (
              <LinkButton
                href={`/about`}
                className="col-start-3 col-end-4 w-fit"
              >
                Know More
              </LinkButton>
            )}
...
const educationInfo = [
  {
    ...
    subTitle: "Govt. Enggineering College, Jhalawar | 2019 ~ 2023",
    list: [
      "Studied core concepts of Computer Science",
      "Graduated with Extra 20 credits for Hons.",
      "Got 8.5 Grade points out of 10.",
    ],
  },
];

...
import avatar from "../public/avatar_illustration.png";
...
const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        LEARNER PROGRAMMER FREELANCER FULL-STACK DEVELOPER
      </span>
        ...
        <div className="relative w-72 md:w-80 h-80 flex items-center mx-auto">
          <div className="absolute pointer-events-none scale-90 xs:scale-95 mx-auto">
            <Image
              ...
              aria-label="A Programmer character illustration levitating with a Macbook"
              alt="A Programmer character illustration"
            />
          </div>
        </div>
      </div>
      ...
      <div className="lg:basis-2/3 z-10 relative">
        <span className="text-darkred lg:text-lg font-medium dark:text-lightred">
          Hi my name is
        </span>
        ...
        <div className="overflow-hidden">
          <span className="text-animation text-2xl md:text-3xl lg:text-5xl block md:my-3 text-darkred dark:text-lightred font-medium">
            A Full-stack Developer
          </span>
        </div>
        <div className="mt-2 my-4 md:mb-8">
          <p className="mb-1">
          A Software Developer, with excellent problem solving skills, passionate about Web Development, DevOps and OpenSource.
          </p>
          <p>
            Making projects and experimenting with evergrowing technology.
            I have expertise in React and NextJS on the frontend, and
            Django, NodeJS on the backend, a little bit of DevOps.
            With a mix bag of various technical skills and creative problem-solving skill 
            I'm just a Lazy coder tryin' to run my code faster.
          </p>
        </div>
      ...
      >
        <span className="group-hover:text-darkred dark:group-hover:text-lightred">
          Scroll
        </span>
        <svg
          ...
          width="24"
          height="24"
          className="dark:fill-bglight group-hover:fill-darkred dark:group-hover:fill-lightred"
        >
